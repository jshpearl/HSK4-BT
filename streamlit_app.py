...
def show_lesson_16(student_name):
    ...
    with t_read:
        ...
        q27_30_texts = [
            ...
            "29. A：外面雪下得这么大，那些小伙子们怎么都跑外边去了？\nB：他们都是南方人，南方冬天很少下雪，更不用说这么大的雪，所以他们肯定特别（ ）氧化。",
...
def show_lesson_17(student_name):
    ...
    with t_read:
        ...
        q23_26_texts = [
            "23. 小姐，您的包不能带入馆内。\n（ 入口 ） 处有专门存包的地方，您可以把包放在那儿。",
            "24. 有的父母为了让孩子更好地发展而对孩子从小就\n（ 严格 ） 要求，却忘记了快乐地生活对孩子才是最重要的。",
