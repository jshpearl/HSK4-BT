            ...
            if user_q6_12[i] != q6_12_ans[i]:
                ...
                with st.expander(f"📖 Xem Lời thoại (Script) Câu {i+6}"):
                    scripts_p2 = [
                        ...
                        "女：小刘，帮我把公司的这两页材料传真给李记者，他下周的一篇新闻里要用 这些数字。\n男：好，我马上去。他的传真号码是多少？\n问：对话最可能发生在哪儿？",
...
with tab_reading:
    ...
    q35_43_questions = [
        ...
        "36. 举办这次 活动，主要是为了向大家介绍我们公司推出的最新手机，希望通过这次活动引起大家的兴趣，让大家更了解我们。\n★ 举办这次活动是为了：",
        "37. 在别人伤心难过的时候，我们总会对他/她表示同情。同情是最美好的情感之一，然而同情并不是高高在上的关心，它应该是对别人的理解、尊重和支持。\n★ 这段话认为，同情别人：",
        "38. 现在的输或者赢都 只是暂时的, 没有人会永远输，也没有人会一直赢。生活的关键就是：只要你敢想、敢做、积极努力了，那么无论是输还是赢，生活都一样精彩。\n★ 根据这段话，可以知道：",
    ...
    q35_43_options = [
        ...
        ["A. 保护孩子安全", "B. 教育孩子", "C. 回答问题", "D. 替孩子做 决定"],
